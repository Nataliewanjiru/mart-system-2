    ...
    fetch('http://127.0.0.1:5070/verify', {
      ...
      .then(data => {
        if (data.message === 'Invalid verification token.') {
          ...
          setMessage(<div><h2>Email verification complete.</h2><p><Link to="/martactive">To activate the mart on the app</Link></p></div>)
        }
      })
      .catch(error => {
...
export default MartVerification